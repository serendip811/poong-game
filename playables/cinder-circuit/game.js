  ...
  const WAVE_CONFIG = [
    {
      ...
      note: "작업장을 조금 넓게 열어 둔 첫 워밍업 구간. 기본 회피와 첫 포지 욕심을 차분하게 읽히게 만든다.",
      directive: "폭주 지형 없음. 넓어진 외곽을 돌며 과열과 드랍 회수 감각부터 익힌다.",
      hazard: null,
    },
    {
      id: "pressure",
      ...
      note: "첫 제련 폭주가 들어오지만 방 전체를 묶지는 않는다. 이동선을 익히며 열린 측면을 남겨 둔다.",
      directive: "단일 Cinder Surge. 넓어진 안전 지대를 계속 갈아타며 Wave 3 도약 전 dodge lane을 만든다.",
      hazard: {
