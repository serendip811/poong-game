(function () {
  ...
  const WAVE_CONFIG = [
    ...
    },
    {
      ...
      note: "최종 전장은 Wave 11에서 비워 둔 tax를 한 번에 되돌린다. relay crown과 ignition ring이 같은 pocket을 닫고 lancer가 빈 각을 찌르므로, 방금 벌어 둔 lane ownership를 마지막 돌파 창으로 직접 바꿔야 한다.",
      directive:
