(function () {
  ...
  const SHARED_LATE_ACT_ENCOUNTER_POOL = {
    ...
    9: {
      label: "Wave 10 · Crownsplit Breach",
      bandId: "crownsplit_breach",
      bandLabel: "Crownsplit Breach",
      bandFocusId: "doctrine_capstone",
      pressureFamily: "breach",
      note: "두 번째 판은 같은 hunt의 반복이 아니라 첫 real breach proof로 꺾인다. 열린 gallery에서 벌어 둔 space ownership를 더 좁은 proof arena와 늦게 닫히는 relay corridor 한 줄로 압축해, headline form이 마지막 문을 직접 열 수 있는지 바로 묻게 만든다.",
      directive:
        "crownsplit breach. relay crown이 corridor 한 줄만 늦게 잠그고 lancer wedge가 탈출각을 시험한다. 먼저 넓은 pocket을 먹은 뒤 마지막에 닫히는 회랑만 짧게 찢어, payoff에서 만든 dominance를 실제 breach 창으로 바꿔야 한다.",
