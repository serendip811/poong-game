...
assert.equal(earlyRoadmap.steps.length, 2);
assert.equal(earlyRoadmap.steps[0].title, "Storm Artillery Doctrine");
assert.equal(earlyRoadmap.steps[1].title, "Sky Lance Frame");
...
assert.equal(primedRoadmap.steps[0].title, "Sky Lance Frame");
assert.equal(primedRoadmap.steps[0].state, "primed");
...
assert.ok(lockgridRoadmap.prompt.includes("Lockgrid Hunt"));
assert.ok(lockgridRoadmap.note.includes("Lockgrid Hunt"));
...
assert.equal(afterburnFour.hazard.type, "salvage");
assert.equal(afterburnFive.hazard.type, "drift");
...
assert.ok(afterburnFive.mix.shrike > afterburnFive.mix.mortar);
