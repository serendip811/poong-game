...
assert.ok(wave6Choices.some((choice) => choice.bayUnlock));
...
assert.ok(wave6DoctrineChoices[0]?.bayUnlock);
...
assert.ok(bastionOvercommitChoices[0]?.bayUnlock);
