...
assert.equal(mirrorWaveEleven.label, "Wave 11 · Starforge Pursuit");
assert.equal(mirrorWaveTwelve.label, "Wave 12 · Cinder Bastion");
assert.equal(bastionWaveNine.label, "Wave 9 · Payoff Sweep+");
assert.equal(bastionWaveTen.label, "Wave 10 · Crown Proof+");
assert.equal(bastionWaveEleven.label, "Wave 11 · Starforge Pursuit");
assert.equal(bastionWaveTwelve.label, "Wave 12 · Cinder Bastion");
assert.equal(artilleryWaveNine.label, "Wave 9 · Payoff Sweep+");
assert.equal(artilleryWaveTen.label, "Wave 10 · Crown Proof+");
assert.equal(artilleryWaveEleven.label, "Wave 11 · Starforge Pursuit");
assert.equal(artilleryWaveTwelve.label, "Wave 12 · Cinder Bastion");
