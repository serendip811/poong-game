...
assert.ok(afterburnOne.mix.brander > afterburnOne.mix.mortar);
assert.ok(afterburnTwo.mix.brander > afterburnTwo.mix.mortar);
assert.ok(afterburnThree.mix.brander > afterburnThree.mix.skimmer);
assert.ok(afterburnOne.mix.brander >= 0.08);
assert.ok(afterburnTwo.mix.brander >= 0.085);
assert.ok(afterburnThree.mix.brander >= 0.075);
