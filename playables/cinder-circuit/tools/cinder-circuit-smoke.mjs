...
assert.equal(mirrorWaveNine.label, "Wave 9 · Payoff Sweep+");
...
assert.equal(bastionWaveNine.label, "Wave 9 · Payoff Sweep+");
...
assert.equal(artilleryWaveNine.label, "Wave 9 · Payoff Sweep+");
...
assert.equal(bastionWaveNine.pressureFamily, "crossfire");
assert.equal(artilleryWaveNine.pressureFamily, "crossfire");
