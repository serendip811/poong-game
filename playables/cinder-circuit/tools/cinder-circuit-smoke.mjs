...
assert.equal(game.WAVE_CONFIG[9].activeCap, 29);
...
assert.equal(game.WAVE_CONFIG[9].arena.width, 1700);
...
assert.ok(game.WAVE_CONFIG[9].hazard.relayWidth < game.WAVE_CONFIG[11].hazard.relayWidth);
assert.equal(game.WAVE_CONFIG[9].hazard.type, "relay");
assert.equal(game.WAVE_CONFIG[9].pressureFamily, "crossfire");
...
assert.equal(game.WAVE_CONFIG[9].arena.height, 980);
assert.equal(game.WAVE_CONFIG[9].hazard.type, "relay");
...
assert.equal(lockgridEscalation.bandId, "crownsplit_breach");
...
assert.equal(sharedLateWaveTen.label, "Wave 10 · Crownsplit Breach");
