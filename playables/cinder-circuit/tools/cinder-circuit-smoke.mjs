...
assert.ok(game.WAVE_CONFIG[9].mix.binder > game.WAVE_CONFIG[9].mix.warden);
assert.ok(game.WAVE_CONFIG[9].mix.binder > game.WAVE_CONFIG[9].mix.mortar);
...
assert.ok(game.WAVE_CONFIG[10].mix.binder > game.WAVE_CONFIG[10].mix.warden);
...
assert.ok(game.WAVE_CONFIG[11].mix.binder > game.WAVE_CONFIG[11].mix.warden);
...
assert.ok(mirrorWaveTen.mix.binder > mirrorWaveTen.mix.mortar);
assert.ok(mirrorWaveTen.mix.binder > mirrorWaveTen.mix.skimmer);
assert.ok(mirrorWaveEleven.mix.binder > mirrorWaveEleven.mix.mortar);
...
assert.ok(afterburnOne.mix.binder > afterburnOne.mix.warden);
assert.ok(afterburnTwo.mix.binder > afterburnTwo.mix.mortar);
assert.ok(afterburnThree.mix.binder > afterburnThree.mix.warden);
