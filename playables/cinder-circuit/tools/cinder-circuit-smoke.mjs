...
assert.equal(mirrorWaveEleven.arena.width, 1880);
assert.equal(mirrorWaveTwelve.arena.height, 1020);
assert.equal(bastionWaveEleven.arena.width, 1660);
assert.equal(bastionWaveTwelve.arena.height, 940);
assert.equal(artilleryWaveEleven.arena.width, 1900);
