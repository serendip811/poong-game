...
assert.ok(mirrorWaveEleven.hazard.relayRange > 500);
...
assert.ok(mirrorWaveTwelve.hazard.count > mirrorWaveEleven.hazard.count);
...
assert.ok(afterburnFour.activeCap < afterburnSix.activeCap);
...
assert.ok(afterburnFive.activeCap < afterburnSeven.activeCap);
