...
const crownPayoff = game.resolveWaveConfig(10, crownWindowBuild);
const crownEscalation = game.resolveWaveConfig(11, crownWindowBuild);
assert.equal(crownPayoff.bandId, "cinder_crown");
assert.equal(crownEscalation.bandId, "cinder_crown");
...
assert.ok(temperCashoutWave.activeCap < finalCashoutWave.activeCap);
