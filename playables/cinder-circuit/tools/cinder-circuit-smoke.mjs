...
assert.ok(mirrorWaveTen.mix.brander > mirrorWaveTen.mix.mortar);
assert.ok(mirrorWaveTen.mix.brander >= 0.14);
...
assert.ok(mirrorWaveEleven.mix.brander >= 0.13);
assert.ok(mirrorWaveTwelve.mix.brander > mirrorWaveTwelve.mix.mortar);
assert.ok(mirrorWaveTwelve.mix.brander >= 0.12);
...
assert.ok(afterburnSeven.mix.brander > afterburnSeven.mix.binder);
